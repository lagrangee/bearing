  ...
  return projectGenerationSchema.parse({
    ...
    brief: {
      ...
      value: {
        ...
        atAGlance: "Restore managed planning context without expanding Bearing Scope.",
        currentPosition: "Review the revised G3 reading contract.",
        establishedBaseline: ["Direct semantic reading and clean-cut boundaries are delivered."],
  ...
  return createProviderScopeObservation({
    ...
    projection: {
      ...
      map: {
        ...
        destination: projection.map.destination.map((section) => ({
          ...section,
          markdown: "Triage release work without enrolling it in Bearing Scope.",
        })),
      },
    },
  });
