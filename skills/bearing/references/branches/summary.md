...
Maintain the accepted project-level synthesis without turning it into a backlog or replacing canonical detail. This internal branch continues from established public orientation and never re-enters the public router. It is the sole mutation owner of Project Summary.
...
5. **Refresh orientation.** Run `$HOME/.bearing/bin/bearing sync --repo <repo-root>` and verify the Summary is in the Sitemap input manifest. Completion: subsequent public Bearing orientation sees the revision.
