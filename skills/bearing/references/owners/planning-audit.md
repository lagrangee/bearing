# Planning Audit Owner

## Applicability

Use only for an explicit Planning Audit request.

## Authority

Planning Audit owns current evidence-backed analysis. It may identify material unresolved findings
and coordinate their promotion, but it cannot accept decisions or mutate other planning meaning.
...
One explicit Audit produced current evidence-backed analysis, promoted no duplicate decision
question, and changed no unrelated semantic owner.
