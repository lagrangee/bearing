...
import { mattProviderSemanticDocuments } from "../providers/matt-skills-v1/projection";
...
export const createPortalProjectQueryService = (options: {
  ...
  readonly linkedContentPreview?: LinkedContentPreviewService;
}) => {
  const linkedContentPreview =
    options.linkedContentPreview ??
    ...
    read: async (
      ...
      try {
        ...
        return {
          ...
          error: {
            code: "project-read-model-unavailable",
    ...
    search: async (entryId: string, query: string) => {
      ...
      try {
        ...
        return {
          ...
          error: {
            code: "project-read-model-unavailable",
            message: "Project Find is unavailable.",
          },
        };
      }
    },
